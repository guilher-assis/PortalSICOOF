      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <a class="brand" href="index.php">SICOOF - V.2.0</a>
       ...
       <span class="sair"><button class="btn" id="cartao" title="Gerar hash Cartão"><i class="icon-shopping-cart"></i></button></span>
...
<br>
    ...
    function htmlFooter() {
        ...
        echo '<footer>
           <hr/>
    <p style=" text-align: center">Sistema de Controle de Ofertas</p>
</footer>
